"""
FINAL DRY-RUN TEST with properly consolidated data
- One Alma course entry per Course Code + Book Title
...
print("=" * 70)
print("FINAL DRY-RUN TEST - PROPERLY CONSOLIDATED DATA")
print("=" * 70)
print()
...
# Use the final consolidated file
input_file = '/Users/patty_home/Desktop/Agentic AI/projects/030226_test/test_22_courses_final_consolidated.xlsx'

print(f"Input file: test_22_courses_final_consolidated.xlsx")
